    ...
    <div className="home">
      ...
      <section className="hero">
        ...
        <div className="container hero-content">
          ...
          <div className="hero-actions">
            ...
            <a
              href={`https://wa.me/${process.env.REACT_APP_WHATSAPP_NUMBER || '573202262501'}`}
              target="_blank"
              rel="noreferrer"
      ...
      <section className="cta-section">
        <div className="container cta-content">
          ...
          <a
            href={`https://wa.me/${process.env.REACT_APP_WHATSAPP_NUMBER || '573202262501'}?text=Hola! Quiero información sobre sus productos.`}
            target="_blank"
            rel="noreferrer"
